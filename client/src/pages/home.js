        ...
        <div style={{backgroundImage: "url('https://transparenttextures.com/patterns/always-grey.png')"}}>
            <div class="container col-xxl-8 px-4 py-5">
                ...
                <div class="col-10 col-sm-8 col-lg-6">
                    <img src="https://cdn.discordapp.com/attachments/798251319847813200/1114605006927184073/CodeHive-Logo-Isolated-3.png" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy"></img>
                </div>
                <div class="col-lg-6">
